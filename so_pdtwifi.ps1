# smpdtwifi-service.ps1 - Version 1.06
...
$exePath = "C:\Program Files (x86)\StationMaster\PDTWiFi64.exe"
$startupDir = "C:\Program Files (x86)\StationMaster"
if (-Not (Test-Path $exePath)) {
    Write-Error "Executable not found: $exePath. Exiting."
    Exit 1
}
# Install PDTWiFi64.exe as a service
$serviceName = "SO PDTWifi"
$displayName = "SO PDTWifi"
...
& $nssmPath set $serviceName Description "Keeps PDTWiFi64.exe running."
